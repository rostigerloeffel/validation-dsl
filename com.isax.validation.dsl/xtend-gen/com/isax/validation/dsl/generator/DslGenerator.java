...
public class DslGenerator implements IGenerator {
  ...
  public String selectorExpression(final SelectorList list) {
    ...
    if (_and) {
      ...
      final Function1<Selector, CharSequence> _function = new Function1<Selector, CharSequence>() {
        public CharSequence apply(final Selector s) {
  ...
  public String argumentList(final ArgumentList list) {
    ...
    if (_notEquals) {
      ...
      final Function1<Argument, CharSequence> _function = new Function1<Argument, CharSequence>() {
        public CharSequence apply(final Argument argument) {
