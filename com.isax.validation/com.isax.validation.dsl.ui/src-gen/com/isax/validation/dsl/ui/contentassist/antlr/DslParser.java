		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getParentAccess().getAlternatives_1(), "rule__Parent__Alternatives_1");
					put(grammarAccess.getChildAccess().getAlternatives_1(), "rule__Child__Alternatives_1");
					put(grammarAccess.getAncestorAccess().getAlternatives_1(), "rule__Ancestor__Alternatives_1");
					put(grammarAccess.getDescendantAccess().getAlternatives_1(), "rule__Descendant__Alternatives_1");
					...
					put(grammarAccess.getTargetDefinitionAccess().getGroup_0(), "rule__TargetDefinition__Group_0__0");
					...
					put(grammarAccess.getMustHaveAccess().getGroup(), "rule__MustHave__Group__0");
					put(grammarAccess.getMustNotHaveAccess().getGroup(), "rule__MustNotHave__Group__0");
					put(grammarAccess.getCanHaveAccess().getGroup(), "rule__CanHave__Group__0");
					...
					put(grammarAccess.getAtLeastAccess().getGroup(), "rule__AtLeast__Group__0");
					put(grammarAccess.getAtMostAccess().getGroup(), "rule__AtMost__Group__0");
					put(grammarAccess.getExactlyAccess().getGroup(), "rule__Exactly__Group__0");
					...
					put(grammarAccess.getAncestorAccess().getGroup(), "rule__Ancestor__Group__0");
					put(grammarAccess.getDescendantAccess().getGroup(), "rule__Descendant__Group__0");
					...
					put(grammarAccess.getDefinitionSentenceAccess().getQuantifierAssignment_2(), "rule__DefinitionSentence__QuantifierAssignment_2");
					put(grammarAccess.getDefinitionSentenceAccess().getKindAssignment_3(), "rule__DefinitionSentence__KindAssignment_3");
					put(grammarAccess.getDefinitionSentenceAccess().getAxisAssignment_4(), "rule__DefinitionSentence__AxisAssignment_4");
					put(grammarAccess.getDefinitionSentenceAccess().getTargetAssignment_5(), "rule__DefinitionSentence__TargetAssignment_5");
					put(grammarAccess.getConstraintSentenceAccess().getQuantificationsAssignment_0_1_1(), "rule__ConstraintSentence__QuantificationsAssignment_0_1_1");
					put(grammarAccess.getConstraintSentenceAccess().getPredicateAssignment_3(), "rule__ConstraintSentence__PredicateAssignment_3");
					...
					put(grammarAccess.getTargetDefinitionAccess().getLocalAssignment_0_0(), "rule__TargetDefinition__LocalAssignment_0_0");
					put(grammarAccess.getTargetDefinitionAccess().getDefinitionAssignment_1(), "rule__TargetDefinition__DefinitionAssignment_1");
					put(grammarAccess.getTargetDefinitionAccess().getBodyAssignment_2_2(), "rule__TargetDefinition__BodyAssignment_2_2");
					put(grammarAccess.getTargetDefinitionAccess().getThenAssignment_3_1(), "rule__TargetDefinition__ThenAssignment_3_1");
					...
					put(grammarAccess.getNotExpressionAccess().getNegatedAssignment_0(), "rule__NotExpression__NegatedAssignment_0");
					put(grammarAccess.getNotExpressionAccess().getInnerAssignment_1(), "rule__NotExpression__InnerAssignment_1");
					put(grammarAccess.getPrimaryExpressionAccess().getCallAssignment_0(), "rule__PrimaryExpression__CallAssignment_0");
					put(grammarAccess.getPrimaryExpressionAccess().getInnerAssignment_1_1(), "rule__PrimaryExpression__InnerAssignment_1_1");
					put(grammarAccess.getPredicateCallAccess().getErrorAssignment_1_1(), "rule__PredicateCall__ErrorAssignment_1_1");
					put(grammarAccess.getPredicateXExpressionAccess().getExpressionAssignment(), "rule__PredicateXExpression__ExpressionAssignment");
