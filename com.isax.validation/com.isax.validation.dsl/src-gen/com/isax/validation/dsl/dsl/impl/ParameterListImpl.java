 ...
 * </p>
 * <ul>
 *   <li>{@link com.isax.validation.dsl.dsl.impl.ParameterListImpl#getParameters <em>Parameters</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ParameterListImpl extends MinimalEObjectImpl.Container implements ParameterList
{
  ...
  {
    return DslPackage.Literals.PARAMETER_LIST;
  }
  ...
  public EList<Parameter> getParameters()
  {
    if (parameters == null)
    {
      parameters = new EObjectContainmentEList<Parameter>(Parameter.class, this, DslPackage.PARAMETER_LIST__PARAMETERS);
    }
    return parameters;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case DslPackage.PARAMETER_LIST__PARAMETERS:
