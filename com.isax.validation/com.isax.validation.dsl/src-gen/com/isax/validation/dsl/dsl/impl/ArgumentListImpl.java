...
public class ArgumentListImpl extends MinimalEObjectImpl.Container implements ArgumentList
{
  ...
  {
    return DslPackage.Literals.ARGUMENT_LIST;
  }
  ...
  public EList<Argument> getArguments()
  {
    if (arguments == null)
    {
      arguments = new EObjectContainmentEList<Argument>(Argument.class, this, DslPackage.ARGUMENT_LIST__ARGUMENTS);
    }
    return arguments;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case DslPackage.ARGUMENT_LIST__ARGUMENTS:
