...
public class DslScopeProvider extends AbstractDeclarativeScopeProvider {
  public IScope scope_DefinitionSentence_node(final DefinitionSentence sentence, final EReference reference) {
    IScope _xblockexpression = null;
    {
      ...
      Iterable<DefinitionSentence> _filter_3 = IterableExtensions.<DefinitionSentence>filter(_filter_2, _function_3);
      ...
      Iterable<NodeDefinition> _map_1 = IterableExtensions.<DefinitionSentence, NodeDefinition>map(_filter_3, _function_4);
      ...
      Iterable<NodeDefinition> _filter_4 = IterableExtensions.<NodeDefinition>filter(_map_1, _function_5);
      EList<Sentence> _sentences_2 = validator.getSentences();
      Iterable<StartOnSentence> _filter_5 = Iterables.<StartOnSentence>filter(_sentences_2, StartOnSentence.class);
      final Function1<StartOnSentence, NodeDefinition> _function_6 = (StartOnSentence s) -> {
        return s.getDefinition();
      };
      Iterable<NodeDefinition> _map_2 = IterableExtensions.<StartOnSentence, NodeDefinition>map(_filter_5, _function_6);
      IScope _scopeFor = Scopes.scopeFor(_map_2);
      _xblockexpression = Scopes.scopeFor(_filter_4, _scopeFor);
    }
  ...
  public IScope scope_Quantification_nodeSet(final Quantification quantification, final EReference reference) {
    IScope _xblockexpression = null;
    {
      ...
      Iterable<DefinitionSentence> _filter_1 = IterableExtensions.<DefinitionSentence>filter(_filter, _function);
      Iterable<Pair<Integer, DefinitionSentence>> _indexed = IterableExtensions.<DefinitionSentence>indexed(_filter_1);
      final Function1<Pair<Integer, DefinitionSentence>, Boolean> _function_1 = (Pair<Integer, DefinitionSentence> p) -> {
        Integer _key = p.getKey();
        return Boolean.valueOf(((_key).intValue() < index));
      };
      Iterable<Pair<Integer, DefinitionSentence>> _filter_2 = IterableExtensions.<Pair<Integer, DefinitionSentence>>filter(_indexed, _function_1);
      ...
      Iterable<NodeDefinition> _map = IterableExtensions.<Pair<Integer, DefinitionSentence>, NodeDefinition>map(_filter_2, _function_2);
      final Function1<NodeDefinition, Boolean> _function_3 = (NodeDefinition d) -> {
        return Boolean.valueOf(d.isCollection());
      };
      Iterable<NodeDefinition> _filter_3 = IterableExtensions.<NodeDefinition>filter(_map, _function_3);
      _xblockexpression = Scopes.scopeFor(_filter_3);
    }
    return _xblockexpression;
  }
}
