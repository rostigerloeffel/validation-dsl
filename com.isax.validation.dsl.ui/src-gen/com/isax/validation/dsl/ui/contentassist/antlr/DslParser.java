		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getSelectorListDefAccess().getAlternatives_1_0(), "rule__SelectorListDef__Alternatives_1_0");
					put(grammarAccess.getAndExpressionAccess().getAlternatives_1_1(), "rule__AndExpression__Alternatives_1_1");
					put(grammarAccess.getImpliesExpressionAccess().getAlternatives_1_0(), "rule__ImpliesExpression__Alternatives_1_0");
					...
					put(grammarAccess.getConstraintSentenceAccess().getGroup_3_0(), "rule__ConstraintSentence__Group_3_0__0");
					...
					put(grammarAccess.getTargetDefinitionAccess().getPredicateAssignment_2_3(), "rule__TargetDefinition__PredicateAssignment_2_3");
					put(grammarAccess.getTargetDefinitionAccess().getAssignmentsAssignment_3_3(), "rule__TargetDefinition__AssignmentsAssignment_3_3");
					...
					put(grammarAccess.getImpliesExpressionAccess().getRhsAssignment_1_1(), "rule__ImpliesExpression__RhsAssignment_1_1");
